    ...
    query MyQuery {
      allFile(
        filter: {
          ...
          extension: {}
          name: { in: ["testimonial-01", "testimonial-02"] }
        }
      ) {
        edges {
          node {
      ...
      <ContentWrapper>
        <ColumnOne>
          <Testimonial>
            ...
            <h3>Sean Michaels</h3>
            <p>
              "The greatest experience of my life! It was so fun exploring the
          ...
          <Testimonial>
            ...
            <h3>Sarah Kin</h3>
            <p>
              "It was so easy to set up my trip! They answered al my questions
